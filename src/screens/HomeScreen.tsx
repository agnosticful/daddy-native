            ...
            <TouchableOpacity
              onPress={async () => {
                await Notifications.presentLocalNotificationAsync({
                  title: "Local Notification from Expo!",
                  body: "Hey! How's going on your application development!",
                  data: { foo: "なーにがデータじゃ、ぶっ飛ばすぞ" },
                  ios: {
                    sound: true
                  },
                  android: {
                    icon:
                      "https://avatars3.githubusercontent.com/u/47763683?s=200&v=4",
                    color: "red"
                  }
                });
              }}
              style={styles.helpLink}
            >
              <Text style={styles.helpLinkText}>Notify me locally</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
